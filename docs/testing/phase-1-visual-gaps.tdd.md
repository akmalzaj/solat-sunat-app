...
4. **Grid & Komposisi Kad Panduan (MEDIUM):** Grid kad panduan responsif (1 lajur pada mudah alih, 2 lajur pada tablet >=640px, 3 lajur pada desktop >=1024px) dengan cip kategori (kategori panduan sebenar, cth. `HARIAN`; sampel teknikal `contoh-struktur` telah dikeluarkan daripada penemuan pengguna), lencana rakaat (`2 Rakaat`), status hukum/semakan (`Belum disemak`), dan butang tindakan.
